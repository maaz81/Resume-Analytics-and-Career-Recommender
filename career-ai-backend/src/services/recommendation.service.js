...
export const defaultProjects = [
    {
        ...
        description: 'A complete e-commerce platform with Stripe payment integration, cart state management, and an admin dashboard.',
    ...
    },
    {
        ...
        description: 'WebSockets based chat app allowing group channels and direct messaging with typing indicators.',
        stack: ['React', 'Express', 'Socket.io', 'Redis'],
        difficulty: 'Intermediate',
        color: 'border-l-status-info-main',
        accent: '#06b6d4',
    },
    {
        id: 3,
        title: 'Portfolio Website',
        description: 'A responsive personal portfolio with blog integration and contact form using email service.',
        stack: ['HTML', 'CSS', 'JavaScript'],
        difficulty: 'Beginner',
        color: 'border-l-status-success-main',
        accent: '#10b981',
    }
];
